...
-->            
    ...
    <sch:pattern id="flags_and_fields_and_datatypes">
        ...
        <sch:rule context="m:field | m:model//m:define-field">
            ...
            <sch:report id="forbid-unwrapped-xml-except-markupmultiline" test="$as-composed/@in-xml='UNWRAPPED' and not($as-composed/@as-type='markup-multiline')">Only 'markup-multiline' fields may be unwrapped in XML.</sch:report>
        </sch:rule>
